            ...
            <div class="page-title">
                ...
                <div class="crumbs">
                    <ul id="breadcrumbs" class="breadcrumb">
                        ...
                        <li class="active"><a >{{ $info->heading }}</a> </li>
                    </ul>
                </div>
            </div>
        </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            @if ($errors->all())
                                             <div class="alert alert-danger">
                                              ...
                                              @endif
                                            <form class="form-horizontal" action={{ route('banner.update',$info->id) }} method="POST" enctype="multipart/form-data">
                                                @csrf
                                                @method('PATCH')
                                                <div class="form-group mb-4">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input class="form-control" name="heading" type="text" value="{{ $info->heading }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group mb-4">
                                                ...
                                                <div class="form-group mb-4">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="text" name="publisher" class="form-control" value="{{ $info->publisher }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group mb-4">
                                                ...
                                                <img style="width: 50px; margin-left: 35%; " src="{{ asset('uploads/banner') }}/{{ $info->banner }}" alt="{{ $info->banner }}">
                                                <div class="align-center"> 
                                                    <input value="Change" class="btn mt-5 mb-4" type="submit">
                                                    <a href="{{ route('banner.index') }}" class="btn mt-5 mb-4 bg-danger border-danger" type="submit"> Cancel</a>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
