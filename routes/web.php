...
Route::get('home/update/logo/and/banner', [App\Http\Controllers\HomeController::class, 'updatelogobanner'])->name('update.logo.banner');
Route::post('home/update/top/logo/{id}', [App\Http\Controllers\HomeController::class, 'updatetoplogo'])->name('update.top.logo');
Route::post('home/update/bottom/logo/{id}', [App\Http\Controllers\HomeController::class, 'updatebottomlogo'])->name('update.bottom.logo');
Route::post('home/update/banner/{id}', [App\Http\Controllers\HomeController::class, 'updatebanner'])->name('update.banner');
